...
Mesh::Mesh(std::vector<Vertex> vertices, std::vector<unsigned int> indices, std::vector<Texture> textures, const glm::mat4* instanceMatrices, unsigned int instanceCount)
{
...
void Mesh::setupMesh(const glm::mat4* instanceMatrices, unsigned int instanceCount)
{
    ...
    {
        setupMeshInstanced(instanceMatrices, instanceCount);
    }
    else
    {
...
void Mesh::setupMeshInstanced(const glm::mat4* instanceMatrices, unsigned int instanceCount)
{
    glGenVertexArrays(1, &VAO);
    glGenBuffers(1, &VBO);
    glGenBuffers(1, &EBO);
